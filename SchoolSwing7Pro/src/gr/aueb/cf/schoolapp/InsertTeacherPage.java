...
public class InsertTeacherPage extends JFrame {private static final long serialVersionUID = 1L;
...
errorFirstname.setFont(new Font("Dialog", Font.BOLD, 12));
