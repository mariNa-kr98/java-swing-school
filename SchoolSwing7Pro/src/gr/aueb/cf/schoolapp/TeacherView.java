...
import gr.aueb.cf.schoolappmodel.City;
...
public class TeacherView extends JFrame {
	...
	public TeacherView() {addWindowListener(new WindowAdapter() {
		@Override
...
//			fetchTeacherFromDatabase(Main.getViewTeachersPage().getSelectedId());
		...
		JLabel firstLastName = new JLabel("ΜΑΡΙΝΑ ΚΡΟΜΜΥΔΑ");
		...
		lblFathername.setBounds(70, 265, 175, 27);
		contentPane.add(lblFathername);
		
		JLabel lblPhoneNum = new JLabel("Τηλέφωνο Εκπαιδευτή");
		lblPhoneNum.setBounds(70, 303, 161, 27);
